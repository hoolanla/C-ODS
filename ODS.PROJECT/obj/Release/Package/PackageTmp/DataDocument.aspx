<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="DataDocument.aspx.cs" Inherits="ODS.PROJECT.DataDocument" %>
...
.hiddencol { display: none; }
    ...
    <table border="1"><tr><td>Search</td></tr></table>
...
<asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="grid_RowDataBound" DataKeyNames="doc_id" OnRowCommand="grid_RowCommand"  HeaderStyle-BackColor="#3AC0F2"
        ...
        RowStyle-ForeColor="#3A3A3A"  AllowPaging="True"
         OnPageIndexChanged="grid_PageIndexChanged" OnPageIndexChanging="grid_PageIndexChanging">
...
<ControlStyle Height="20px" Width="20px"></ControlStyle>
            ...
            <asp:BoundField DataField="secure_approve"  ItemStyle-CssClass="hiddencol"  HeaderStyle-CssClass="hiddencol">
<HeaderStyle CssClass="hiddencol"></HeaderStyle>
...
<ItemStyle CssClass="hiddencol"></ItemStyle>
            ...
            <asp:TemplateField HeaderText="Delete">
                   ...
                   <ItemTemplate>
                      ...
                      <asp:LinkButton ID="DELETE" runat="server" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"  CommandName="DELETE">Delete</asp:LinkButton>
                            </ItemTemplate>
            </asp:TemplateField>
        </Columns>
