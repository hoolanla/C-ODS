<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmApplicationPrepare.aspx.cs" Inherits="ODS.PROJECT.FrmApplicationPrepare" %>
...
<div  id="signature1" hidden='hidden'><p id="signature" class="form-pdf"><img src="Images/<%=signature_file.Value %>" width ="160" height="50" /></p></div>
 ...
 <div class="row vertical-center-row"  >
       <img  src="PdfToImage/<%=doc_id.Value %>.PNG"  alt="background image" onmousedown='return  getMouseXY(event);' id="log"  />
</div>
